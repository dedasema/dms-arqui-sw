...
require_once '../versiones/PVersion.php';
require_once '../versiones/PComentario.php';
...
if (isset($_GET['action']) && $_GET['action'] === 'descargar_adjunto') {
    $id = $_GET['id'] ?? 0;
    $c = $pComentario->obtenerComentarioPorId($id);
    if ($c && $c['ruta_archivo']) {
...
$version = $pVersion->obtenerVersionPorId($version_id);
