...
<script>document.getElementById('page-title').textContent = 'Gestionar Gestiones Académicas';</script>

<!-- Header de sección -->
<div class="flex justify-between items-center mb-6">
    <div>
        <h3 class="text-lg font-semibold text-gray-700">Listado de Gestiones Académicas</h3>
        <p class="text-sm text-gray-400 mt-0.5">Administra los periodos académicos del sistema.</p>
    </div>
    <button id="btn-nueva-gestion"
    ...
    <table class="w-full text-left">
        <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
                ...
                <th class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha Inicio</th>
                <th class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha Fin</th>
                <th class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider text-right">Acciones</th>
            </tr>
        </thead>
        <tbody id="tabla-gestiones-body">
            <tr><td colspan="5" class="px-6 py-8 text-center text-gray-400 text-sm">Cargando...</td></tr>
        </tbody>
    </table>
</div>
...
<div id="modal-gestion" class="hidden fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <form id="form-gestion" class="p-6 space-y-4">
            <div>
...
<script src="/presentacion/assets/js/gestiones.js"></script>
